        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
            ...
            <Link
              ...
              className={`flex items-center gap-2 px-6 py-3 ${darkMode ? 'bg-white text-gray-900' : 'bg-gray-900 text-white'} rounded-xl font-semibold ${darkMode ? 'hover:bg-gray-100' : 'hover:bg-gray-800'} transition-colors shadow-lg ${darkMode ? 'shadow-white/10' : 'shadow-gray-900/10'}`}
            >
