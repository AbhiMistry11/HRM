        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 ${darkMode ? 'bg-gray-800' : 'bg-gray-900'} text-white rounded-lg ${darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-800'} transition-colors duration-200 font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed shadow-sm`}
            >
