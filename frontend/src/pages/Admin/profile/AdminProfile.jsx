  ...
  const fetchProfile = async () => {
    try {
      ...
      if (res.data) {
        setProfile(prev => ({
          ...prev,
          personal: res.data.personal || prev.personal,
          professional: res.data.professional || prev.professional,
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
        <div>
          ...
          <p className={getSecondaryTextColor()}>
            Manage your personal information, professional details, and security settings.
          </p>
        </div>
