...
const AnimatedCounter = ({ value, label, color, duration = 2 }) => {
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <span className="text-white font-semibold text-lg">View Positions</span>
                <motion.div
                  animate={{ x: [0, 5, 0] }}
                  transition={{ duration: 1.5, repeat: Infinity }}
                >
        ...
        >
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              >
                <BiSolidArrowToTop size={20} className="group-hover:animate-bounce" />
